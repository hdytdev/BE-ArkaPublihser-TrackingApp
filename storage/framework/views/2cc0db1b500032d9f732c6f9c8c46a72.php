    ...
    <div class="input-group">
        ...
        <template x-if="!useManual">
            <select wire:model="institution_id" class="form-control" name="" id="">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $instansi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\PROJ\Laravel\JurnalTrackingApp\resources\views/livewire/form/select-instansi.blade.php ENDPATH**/ ?>