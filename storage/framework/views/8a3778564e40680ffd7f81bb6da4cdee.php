<div>
     <?php $__env->slot('pageTitle', null, []); ?> 
        <div class="page-title pt-3 mb-1 d-flex justify-content-between align-items-center mb-4">
            ...
            <a wire:navigate href="<?php echo e(route('admin.journal.new')); ?>"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($journals && $journals->count() > 0): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->total_termin); ?></td>
                                        <th>
                                            <button wire:click="delete('<?php echo e($item->id); ?>')" wire:konfirmasi="Apakah anda yakin?"
                                                class="btn btn-sm btn-danger">
                                                Hapus
                                            </button>
                                            <a wire:navigate href="<?php echo e(route('admin.journal.edit', ['id' => $item->id])); ?>"
...
</div><?php /**PATH D:\MyProjects\P-007-TRACKING-APP\resources\views/livewire/journal-list.blade.php ENDPATH**/ ?>