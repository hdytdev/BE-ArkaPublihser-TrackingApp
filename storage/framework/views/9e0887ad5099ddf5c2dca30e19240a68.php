...
$__html = app('livewire')->mount($__name, $__params, 'lw-2329843298-0', $__slots ?? [], get_defined_vars());
...
?>
                  <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['institution_id'];
...
[$__name, $__params] = $__split('form.select-position', ['wire:model' => 'position_id']);

$__html = app('livewire')->mount($__name, $__params, 'lw-2329843298-1', $__slots ?? [], get_defined_vars());
...
if (isset($__slots)) unset($__slots);
?>
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['position_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
