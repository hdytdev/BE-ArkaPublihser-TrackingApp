<div>
    <div class="row mb-3">
        <div class="col-lg-12 col-md-4">
            <div class="card p-4">
                <form wire:submit="submitSearch" action="" class="all-order_form-search d-flex justify-content-between w-100">
...
</div><?php /**PATH D:\PROJ\Laravel\JurnalTrackingApp\resources\views\livewire\show-customer.blade.php ENDPATH**/ ?>