...
<?php endif; ?>
    ...
    <div class="pl-2 flex-1 <?php echo e($inline ? '@md:flex @md:[&>[data-slot="content"]:has([data-slot="heading"]):has([data-slot="text"])+[data-slot="actions"]]:p-2' : ''); ?>">
...
<?php endif; ?>
    ...
    <?php if ($controls): ?>
        <div <?php echo e($controls->attributes->class($inline ? 'pl-2 m-[-2px]' : 'pl-2')); ?>>
            <?php echo e($controls); ?>

        </div>
    <?php endif; ?>
</div>
<?php /**PATH D:\PROJ\Laravel\JurnalTrackingApp\vendor\livewire\flux\stubs\resources\views\flux\callout\index.blade.php ENDPATH**/ ?>