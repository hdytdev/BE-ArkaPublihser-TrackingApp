...
<x-layouts.nav-link icon="tf-icons bx bx-add-to-queue" link="{{route('admin.order.new')}}">Tambah Order</x-layouts.nav-link>
...
<x-layouts.nav-link icon=" tf-icons bx bx-book-add" link="{{route('admin.journal.new')}}">Tambah Jurnal</x-layouts.nav-link>
